...
<head>
  ...
  <meta name="description" content="aplikasi pendaftaran santri darussalam">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="p-5">
                  ...
                  <img src="../assets/img/lg_ds.png" alt="Logo aplikasi pendaftaran" class="img-logo"><p>
                    <h2 class="h4 text-gray-900 mb-5">Login Admin</h2>
                  ...
                  <form class="user" method="POST" action="login_control.php">
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" name="username" aria-describedby="emailHelp" placeholder="Masukan Email">
                    </div>
                    <div class="form-group">
