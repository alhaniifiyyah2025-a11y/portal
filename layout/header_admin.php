      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" style="">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="data_pendaftar.php">Data Pendaftar</a>
            <a class="collapse-item" href="konfirmasi.php">Konfirmasi Pendaftaran</a>
            <a class="collapse-item" href="pembayaran.php">Konfirmasi pembayaran</a>
          </div>
        </div>
      </li>
