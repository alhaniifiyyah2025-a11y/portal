...
include('../config/upload_control.php');
...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-12 text-gray-800">Syarat Pendaftaran</h1>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Upload Foto Resmi 3 x 4</h6>
        </div>
        <div class="card-body">

            <div class="row">
                <div class="form-group floating-label mt-5" style="margin-left: 20px;">
                    <label class="col-sm-12">Upload Foto Resmi 3 x 4(PDF, JPEG, PNG) : </label>
                    <label class="btn btn-success" for="my-file-selector2">
                        ...
                        Upload Foto Resmi 3 x 4 (PDF, JPEG, PNG)
                    </label>
